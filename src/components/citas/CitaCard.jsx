...
export default function ClientCard({ r, onEdit, onArchive, onDelete, canDelete, profile }) {
  ...
  const mensajeWa = encodeURIComponent(
    `Hola ${r.nombres}, te saluda ${nombreAsesor} de Banco Caja Social. Como tu banco amigo, te recordamos que tenemos programada nuestra visita de seguimiento para el día de mañana. ¿Te queda bien el horario acordado para reunirnos? ¡Un amigo hoy, mañana y siempre!`
  );
