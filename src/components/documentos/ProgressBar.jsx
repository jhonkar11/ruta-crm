...
// Colores consistentes con el resto de la paleta de estados (ver Stamp en UIKit.jsx):
// rojo -> ámbar -> verde/teal a medida que avanza el expediente.
function colorForProgress(pct) {
  if (pct >= 100) return "#0D9488"; // completo -> teal (mismo tono que "Desembolsado")
  if (pct >= 50) return "#D97706";  // a mitad de camino -> ámbar
  return "#DC2626";                 // recién iniciado -> rojo
}
